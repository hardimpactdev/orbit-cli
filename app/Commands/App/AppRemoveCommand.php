...
final class AppRemoveCommand extends AppGatewayCommand
{
    ...
    private function renderRemovalTree(string $selector): int
    {
        ...
        $outcome = $this->runStepOperation(
            ...
            [
                ...
                ['label' => 'Stop and remove app processes', 'doneLabel' => 'Stopped and removed app processes'],
    ...
    private function renderRemovalNotes(array $response): void
    {
        ...
        foreach ($messages as $message) {
            $this->line("  - {$message}");
            $this->line('  Run: orbit doctor --family=app --restore');
        }
    }
    ...
    {
        return $this->gatewayDelete($this->apiAppPath($selector), [
