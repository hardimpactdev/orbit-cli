...
return [
    'gateway' => [
        ...
        'operation_follow_reconnect_sleep_ms' => env('ORBIT_GATEWAY_OPERATION_FOLLOW_RECONNECT_SLEEP_MS') !== null ? (int) env('ORBIT_GATEWAY_OPERATION_FOLLOW_RECONNECT_SLEEP_MS') : null,
        'operation_follow_max_empty_replays' => env('ORBIT_GATEWAY_OPERATION_FOLLOW_MAX_EMPTY_REPLAYS') !== null ? (int) env('ORBIT_GATEWAY_OPERATION_FOLLOW_MAX_EMPTY_REPLAYS') : null,
        'operation_follow_max_transient_failures' => env('ORBIT_GATEWAY_OPERATION_FOLLOW_MAX_TRANSIENT_FAILURES') !== null ? (int) env('ORBIT_GATEWAY_OPERATION_FOLLOW_MAX_TRANSIENT_FAILURES') : null,
    ],
];
